...
export default function Features() {
	return (
		<section className="relative overflow-hidden py-16 md:py-24">
			{/* Background */}
			<div className="absolute top-0 right-0 h-96 w-96 animate-pulse-gentle rounded-full bg-linear-to-br from-primary/10 to-primary/10 blur-3xl" />

			<div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
				<div className="mx-auto mb-16 max-w-3xl animate-fadeIn text-center">
					<h2 className="mb-4 text-balance font-bold text-3xl text-foreground tracking-tight sm:text-4xl md:text-5xl">
						Öğrenmeyi <span className="text-primary">kolaylaştıran</span> özellikler
					</h2>
