...
export default function MobileMenu({ pageCategories }: Readonly<MobileMenuProps>) {
	...
	return (
		<>
			...
			{isMobileMenuOpen && (
				<div className="slide-in-from-top-2 fixed inset-x-0 top-20 z-50 animate-in border-t bg-white shadow-lg duration-200 md:hidden">
							...
							{pageCategories.map((category) => (
								...
								>
									<button
										...
										className="flex w-full items-center justify-between py-3 font-medium text-gray-700 transition-colors hover:text-blue-600 focus:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
