		...
		<div className="mx-auto max-w-2xl">
			<Alert className="border-orange-200 bg-orange-50">
				...
				<AlertDescription className="space-y-3 text-orange-700">
					<p>
						<strong>{contentType}</strong> içeriği yüklenemiyor. Bu sorun
						genellikle Strapi yönetim panelinde gerekli izinlerin ayarlanmamış
					...
					<div className="rounded border border-orange-200 bg-white p-3">
						...
						<ol className="list-inside list-decimal space-y-1 text-sm">
							...
							<li>
								<Badge variant="outline">Settings → Roles → Public</Badge>{" "}
								bölümüne gidin
							</li>
							<li>
								<strong>{contentType}</strong> koleksiyonu için{" "}
								<Badge className="bg-green-500">find</Badge> iznini
								etkinleştirin
							</li>
					...
					{endpoint && (
						<div className="rounded bg-orange-100 p-2 text-orange-600 text-xs">
							...
							<code className="rounded bg-white px-1">{endpoint}</code>
						</div>
					)}
